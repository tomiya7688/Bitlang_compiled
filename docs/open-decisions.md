...
## 1. Runtime failure model

Bitlang already defines cases that are errors, including numeric overflow by default and invalid conversions.

For failures that depend on runtime values, compiled/backend behavior still needs a common failure model.
...
## 4. Enum underlying representation
...
## 5. External ABI and symbol contract
...
## 7. Static/module initialization order
...
## 9. Exact Ptr/Ref textual representation
...
## 10. Explicit layout / bit-field facility
